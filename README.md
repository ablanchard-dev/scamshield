...
> Détection d'arnaques et de phishing dans du texte (SMS, e-mails, messages) — moteur de scoring **transparent**, démo Streamlit, pipeline d'entraînement/évaluation et extension Chrome.
...
- **Démo Streamlit** — colle un message, vois le score et les raisons en direct.
...
Le résultat est une probabilité `0–1` + la liste des raisons, ce qui rend chaque
décision **auditable**.
